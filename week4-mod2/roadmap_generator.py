...
PROMPT_B_SYSTEM = (
    ...
    "IMPORTANT: if a skill name is not one you confidently recognize as "
    "an established, real technology or discipline, say so explicitly "
    "(e.g. 'I don't recognize this as an established skill/technology') "
    "instead of inventing a plausible-sounding technical justification "
    "for it. Do not guess or fabricate explanations for unfamiliar terms. "
